function Home()
{
    return(
        ...
        <img className="w-full lg:h-[850px]"src="./images/PARIS.png" alt="" />
        <div className=" w-full p-10 lg:w-1/2 mx-auto my-20 text-xl font-light">
        ...
        <h1 className="text-3xl lg:text-6xl font-extrabold drop-shadow-xl text-white tracking-wider ">EXPERIENCE NEW YEAR EVE AT PARIS</h1>
        </div>
        </div>
        <div>
        ...
        <div className="p-10  w-full lg:w-1/2 bg-gray-300 border-gray-500 rounded-xl mx-auto shadow-2xl">
        ...
        <div className="mt-15 p-10 w-full lg:w-1/2 bg-gray-300 border-gray-500 rounded-xl mx-auto shadow-2xl">
...
She is the core of Ile de France region (12 million people). Founded more than <span className="bg-red-700 opacity-50 rounded-b-lg p-0.5 text-white">2000 years ago</span>, Paris is a modern and vibrant city with significant commercial, cultural, academic, scientific, administrative, business activity.</p>
        ...
        <div className="mt-15 mb-10 p-10 w-full lg:w-1/2 bg-gray-300 border-gray-500 rounded-xl mx-auto shadow-2xl">
